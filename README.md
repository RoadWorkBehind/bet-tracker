...
```bash
   ...
   git branch -M main
   git remote add origin https://github.com/YOUR\_USERNAME/bet-tracker.git
...
(does not work if ran locally on desktop, obviously, but you can try running it locally without npm on an iPhone. I doubt it would work though.)
...
## Betslip Scanner Setup (low cost, but still costs)
